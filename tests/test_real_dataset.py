...
class TestDataset(unittest.TestCase):
    ...
    def test_first_dataset(self):
        ...
        dataset.peak_dict = {
            ...
            '58': dict(sign="-", fitting_group=1, fitting_model="voigt"),
            #'44': dict(sign="-", fitting_group=1, fitting_model="voigt"),
            #'28': dict(sign="-", fitting_group=1, fitting_model="voigt"),
            #'22': dict(sign="-", fitting_group=1, fitting_model="voigt"),
        }
    ...
    def test_first_dataset_1(self):
        ...
        dataset.procno_of_topspin_experiment = "103"
        dataset.output_file_name = r"C:\Users\Florian " \
                                   r"Taube\Desktop\Prolin_auswertung"
        dataset.peak_dict = {
